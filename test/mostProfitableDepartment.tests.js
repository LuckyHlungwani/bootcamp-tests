describe ("Testing the mostProfitableDepartment function", function(){
    ...
    it ("it should return the name of the most profitable department from sales data 2'", function(){
        assert.equal('outdoor', mostProfitableDepartment(salesData), "Most profitable department is 'outdoor' for dataset 2");
      });
      it ("it should return the name of the most profitable day from sales data'", function(){
